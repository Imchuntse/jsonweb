...
export default function GenerateClassNames(babel, path, state, options) {
  ...
  debug(`template-parse:generated-meta:${type}`, `slug: ${slug}, displayName: ${displayName}, className: ${className}`); // Save evaluated slug and displayName for future usage in templateProcessor
